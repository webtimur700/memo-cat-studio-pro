"""Единый источник цветов темы.
     ...
     from __future__ import annotations
    	...
    	class Palette:
    	    ...
    	    accent: QColor = field(default_factory=lambda: QColor(124, 92, 255))      # фиолетовый акцент — фирменный цвет Memo Cat
    	    accent_glow: QColor = field(default_factory=lambda: QColor(124, 92, 255, 90))
    	
    	    score_low: QColor = field(default_factory=lambda: QColor(230, 90, 90))     # viral score < 40
    	    score_mid: QColor = field(default_factory=lambda: QColor(230, 190, 70))    # 40-70
    	    score_high: QColor = field(default_factory=lambda: QColor(90, 220, 140))   # > 70
