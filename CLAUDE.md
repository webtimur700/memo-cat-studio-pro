...
- Тексты LLM клипа считаются в фоне, пока кодируются следующие клипы; запросы к LLM
  идут по одному (`_llm_lock`). Замеры по стадиям: `scripts/profile_pipeline.py`,
  таблица в `docs/performance.md`.
